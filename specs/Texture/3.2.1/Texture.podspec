Pod::Spec.new do |spec|
  ...
  spec.homepage     = 'http://iangeli.org'
  ...
  spec.source       = { :git => 'https://github.com/iangeli/Texture.git', :tag => spec.version.to_s }
  spec.module_name  = 'AsyncDisplayKit'
  spec.header_dir   = 'AsyncDisplayKit'

  spec.documentation_url = 'http://iangeli.org/appledoc/'
